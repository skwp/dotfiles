...
def install_term_theme
  ...
  puts "======================================================"
  plist_substr = `/usr/libexec/PlistBuddy -c "Print :'Custom Color Presets':'Solarized Light' dict" ~/Library/Preferences/com.googlecode.iterm2.plist`
  is_installed = plist_substr.include?("Selected Text Color")
  if is_installed
    puts "iTerm2 solarized theme are already installed!"
  else
