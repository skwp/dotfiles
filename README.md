    ...
    sh -c "`curl -fsSL https://raw.githubusercontent.com/qianthinking/dotfiles/master/install.sh`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/qianthinking/dotfiles/master/install.sh`" -s ask
```
