...
hi Comment        guifg=#b0b0b0 guibg=#f0f0d0 gui=none
...
hi DiffChange     guifg=#f0f0dd guibg=#007ff0 gui=none
...
hi VertSplit      guifg=#f0f0dd guibg=#000066 gui=underline
hi Visual         guifg=#ffffff guibg=#00009c gui=underline
hi VisualNOS      guifg=#ffffff guibg=#b0b0b0 gui=underline
hi WarningMsg     guifg=#ffffff guibg=#cc0000 gui=underline
hi WildMenu       guifg=#f0f0dd guibg=#0000ee gui=underline
